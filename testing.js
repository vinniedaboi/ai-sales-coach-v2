const $ = s => document.querySelector(s);
    ...
    */
    ...
    async function saveItem() {
      ...
      if (!selected) return toast('Select a user first', true);
      ...
      if (!full) {
        try {
          ...
          allInsights.forEach(item => {
            ...
            // Push the item, mapping API names (snake_case) to JS names (camelCase)
          ...
          // Temporarily update the global actionsByEmail for functions that rely on it (like renderSelected)
          // NOTE: This should be removed once all functions fetch data directly.
